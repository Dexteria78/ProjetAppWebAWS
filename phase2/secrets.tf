...
# Utilisation du profil d'instance existant dans AWS Academy (LabInstanceProfile)
# Ce profil a déjà les permissions nécessaires pour accéder à Secrets Manager
